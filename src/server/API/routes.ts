...
const models: TsoaRoute.Models = {
  ...
  "AdditionalFahrzeugInfo": {
    ...
    "properties": {
      ...
      "speise": { "dataType": "boolean" },
      "rollstuhl": { "dataType": "boolean" },
      "fahrrad": { "dataType": "boolean" },
      "comfort": { "dataType": "boolean" },
      "schwebe": { "dataType": "boolean" },
      "ruhe": { "dataType": "boolean" },
      "info": { "dataType": "boolean" },
      "familie": { "dataType": "boolean" },
      "kleinkind": { "dataType": "boolean" },
      "wifi": { "dataType": "boolean" },
      "wifiOff": { "dataType": "boolean" },
    },
    "additionalProperties": false,
  },
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
