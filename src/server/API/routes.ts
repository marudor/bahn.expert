...
export function RegisterRoutes(router: KoaRouter) {
    ...
    // ###########################################################################################################
        ...
        router.post('/api/hafas/subscribe/create',
            ...(fetchMiddlewares<Middleware>(HafasSubscribeController)),
            ...(fetchMiddlewares<Middleware>(HafasSubscribeController.prototype.create)),
        ...
        router.post('/api/hafas/subscribe/delete',
            ...(fetchMiddlewares<Middleware>(HafasSubscribeController)),
            ...(fetchMiddlewares<Middleware>(HafasSubscribeController.prototype.delete)),
        ...
        router.post('/api/hafas/subscribe/createUser',
            ...(fetchMiddlewares<Middleware>(HafasSubscribeController)),
            ...(fetchMiddlewares<Middleware>(HafasSubscribeController.prototype.createUser)),
        ...
        router.get('/api/hafas/subscribe/search',
            ...(fetchMiddlewares<Middleware>(HafasSubscribeController)),
            ...(fetchMiddlewares<Middleware>(HafasSubscribeController.prototype.search)),
        ...
        router.post('/api/hafas/subscribe/deleteUser',
            ...(fetchMiddlewares<Middleware>(HafasSubscribeController)),
            ...(fetchMiddlewares<Middleware>(HafasSubscribeController.prototype.deleteUser)),
        ...
        router.get('/api/hafas/subscribe/details',
            ...(fetchMiddlewares<Middleware>(HafasSubscribeController)),
            ...(fetchMiddlewares<Middleware>(HafasSubscribeController.prototype.details)),
        ...
        router.post('/api/hafas/v1/enrichedJourneyMatch',
            ...(fetchMiddlewares<Middleware>(HafasController)),
            ...(fetchMiddlewares<Middleware>(HafasController.prototype.enrichedJourneyMatch)),
