...
const CacheTTLs: Record<CacheDatabase, string> = {
	...
	[CacheDatabase.StopPlaceSearch]: 'P4D',
	[CacheDatabase.ParsedCoachSequenceFound]: parseCacheTTL(
		'PT15M',
		process.env.COACH_SEQUENCE_CACHE_TTL,
	),
	[CacheDatabase.StopPlaceIdentifier]: 'P4D',
	[CacheDatabase.StopPlaceByEva]: 'P4D',
	[CacheDatabase.StopPlaceByRil]: 'P4D',
	[CacheDatabase.StopPlaceByRilGrouped]: 'P4D',
	[CacheDatabase.StopPlaceGroups]: 'P4D',
	[CacheDatabase.StopPlaceSalesSearch]: 'P4D',
