...
const CacheTTLs: Record<CacheDatabase, string> = {
	[CacheDatabase.IrisTTSStation]: 'P4D',
	[CacheDatabase.TimetableParsedWithWings]: 'P2D',
	[CacheDatabase.DBLageplan]: 'P5D',
	[CacheDatabase.LocMatch]: 'PT48H',
	[CacheDatabase.HIMMessage]: 'PT48H',
	[CacheDatabase.NAHSHLageplan]: 'P5D',
	[CacheDatabase.StopPlaceSearch]: 'P5D',
	...
	[CacheDatabase.HAFASJourneyMatch]: 'PT10H',
	[CacheDatabase.NegativeNewSequence]: 'PT8H',
	[CacheDatabase.HafasStopOccupancy]: 'PT30M',
	[CacheDatabase.AdditionalJourneyInformation]: 'PT20M',
	[CacheDatabase.JourneyFind]: 'P3D',
	[CacheDatabase.JourneyFindV2]: 'P3D',
	[CacheDatabase.JourneyLineFindV2]: 'P3D',
	...
	[CacheDatabase.CoachSequenceRemovedData]: 'P3D',
	[CacheDatabase.VRROccupancy]: 'PT2H',
	[CacheDatabase.VehicleLayoutsMaps]: 'P30D',
