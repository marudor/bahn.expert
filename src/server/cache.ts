...
const CacheTTLs: Record<CacheDatabase, string> = {
  ...
  [CacheDatabase.StopPlaceSearch]: 'PT15M',
  [CacheDatabase.ParsedCoachSequenceFound]: parseCacheTTL(
    'PT15M',
    process.env.COACH_SEQUENCE_CACHE_TTL,
  ),
  [CacheDatabase.StopPlaceIdentifier]: 'PT15M',
  [CacheDatabase.StopPlaceByEva]: 'PT15M',
  [CacheDatabase.StopPlaceByRil]: 'PT15M',
  [CacheDatabase.StopPlaceGroups]: 'PT15M',
  [CacheDatabase.StopPlaceSalesSearch]: 'PT15M',
