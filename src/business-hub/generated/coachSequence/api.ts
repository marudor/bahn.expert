...
export type OccupancyDetail = typeof OccupancyDetail[keyof typeof OccupancyDetail];
...
export const VehicleCategory = {
    ...
    DoubledeckControlcarFirstEconomoyClass: 'DOUBLEDECK_CONTROLCAR_FIRST_ECONOMOY_CLASS',
...
export type VehicleOrientation = typeof VehicleOrientation[keyof typeof VehicleOrientation];
...
export type VehicleSequenceStatus = typeof VehicleSequenceStatus[keyof typeof VehicleSequenceStatus];
...
export const TransportsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        matchingVehicleID: async (vehicleID: string, date?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'vehicleID' is not null or undefined
            assertParamExists('matchingVehicleID', 'vehicleID', vehicleID)
            const localVarPath = `/by-vehicleid/{vehicleID}`
         ...
         * @throws {RequiredError}
         */
        vehicleSequenceArrivalUnmatched: async (date: string, category: string, number: number, evaNumber: string, time: string, includePosition?: boolean, includeAmenities?: boolean, includeOccupancy?: OccupancyDetail, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        vehicleSequenceDeparture: async (journeyID: string, departureID: string, includePosition?: boolean, includeAmenities?: boolean, includeOccupancy?: OccupancyDetail, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/vehicle-sequences/by-departure/{journeyID}/{departureID}`
         ...
         * @throws {RequiredError}
         */
        vehicleSequenceDepartureUnmatched: async (date: string, category: string, number: number, evaNumber: string, time: string, includePosition?: boolean, includeAmenities?: boolean, includeOccupancy?: OccupancyDetail, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'date' is not null or undefined
...
export const TransportsApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = TransportsApiAxiosParamCreator(configuration)
    return {
        /**
         * Returns all journeys [Fahrten] that contain a vehicle [Fahrzeug] with a matching vehicle id order by scheduled deparute time asc. May contain outdated and / or future journeys.
         * @param {string} vehicleID id for vehicle (for rail vehicles usually the UIC identification nunmber)
         ...
         * @throws {RequiredError}
         */
        async matchingVehicleID(vehicleID: string, date?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TransportMatchVehicleIDs>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.matchingVehicleID(vehicleID, date, options);
         ...
         * @throws {RequiredError}
         */
        async vehicleSequenceArrivalUnmatched(date: string, category: string, number: number, evaNumber: string, time: string, includePosition?: boolean, includeAmenities?: boolean, includeOccupancy?: OccupancyDetail, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<VehicleSequenceArrival>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.vehicleSequenceArrivalUnmatched(date, category, number, evaNumber, time, includePosition, includeAmenities, includeOccupancy, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Returns a transports vehicle sequence [Wagenreihung] with optional position at platform [Positionierung am Gleis], amenities [Ausstattungsmerkmalen] and occupancy [Auslastung] for a particular departure.
         ...
         * @throws {RequiredError}
         */
        async vehicleSequenceDeparture(journeyID: string, departureID: string, includePosition?: boolean, includeAmenities?: boolean, includeOccupancy?: OccupancyDetail, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<VehicleSequenceDeparture>> {
         ...
         * @throws {RequiredError}
         */
        async vehicleSequenceDepartureUnmatched(date: string, category: string, number: number, evaNumber: string, time: string, includePosition?: boolean, includeAmenities?: boolean, includeOccupancy?: OccupancyDetail, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<VehicleSequenceDeparture>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.vehicleSequenceDepartureUnmatched(date, category, number, evaNumber, time, includePosition, includeAmenities, includeOccupancy, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const TransportsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        matchingVehicleID(vehicleID: string, date?: string, options?: any): AxiosPromise<TransportMatchVehicleIDs> {
            return localVarFp.matchingVehicleID(vehicleID, date, options).then((request) => request(axios, basePath));
        },
        /**
         * Returns all administrations [Verwaltungen] that provide vehicle sequences [Wagenreihungen].
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        vehicleSequenceAdministrations(options?: any): AxiosPromise<VehicleSequenceAvailableAdministrations> {
         ...
         * @throws {RequiredError}
         */
        vehicleSequenceArrivalUnmatched(date: string, category: string, number: number, evaNumber: string, time: string, includePosition?: boolean, includeAmenities?: boolean, includeOccupancy?: OccupancyDetail, options?: any): AxiosPromise<VehicleSequenceArrival> {
            return localVarFp.vehicleSequenceArrivalUnmatched(date, category, number, evaNumber, time, includePosition, includeAmenities, includeOccupancy, options).then((request) => request(axios, basePath));
        },
        /**
         * Returns a transports vehicle sequence [Wagenreihung] with optional position at platform [Positionierung am Gleis], amenities [Ausstattungsmerkmalen] and occupancy [Auslastung] for a particular departure.
         * @param {string} journeyID id of journey [FahrtID]
         ...
         * @throws {RequiredError}
         */
        vehicleSequenceDeparture(journeyID: string, departureID: string, includePosition?: boolean, includeAmenities?: boolean, includeOccupancy?: OccupancyDetail, options?: any): AxiosPromise<VehicleSequenceDeparture> {
            return localVarFp.vehicleSequenceDeparture(journeyID, departureID, includePosition, includeAmenities, includeOccupancy, options).then((request) => request(axios, basePath));
        },
        /**
         * Returns a transports vehicle sequence [Wagenreihung] with optional position at platform [Positionierung am Gleis], amenities [Ausstattungsmerkmale] and occupancy [Auslastung] for a particular departure. This is the unmatched entrypoint in case the caller is not aware of the particular journeyID and departureID.
         * @param {string} date date (yyyy-mm-dd) of scheduled start of journey [Verkehrstag]
         ...
         * @throws {RequiredError}
         */
        vehicleSequenceDepartureUnmatched(date: string, category: string, number: number, evaNumber: string, time: string, includePosition?: boolean, includeAmenities?: boolean, includeOccupancy?: OccupancyDetail, options?: any): AxiosPromise<VehicleSequenceDeparture> {
            return localVarFp.vehicleSequenceDepartureUnmatched(date, category, number, evaNumber, time, includePosition, includeAmenities, includeOccupancy, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class TransportsApi extends BaseAPI {
     ...
     */
    public matchingVehicleID(requestParameters: TransportsApiMatchingVehicleIDRequest, options?: AxiosRequestConfig) {
        return TransportsApiFp(this.configuration).matchingVehicleID(requestParameters.vehicleID, requestParameters.date, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public vehicleSequenceAdministrations(options?: AxiosRequestConfig) {
        return TransportsApiFp(this.configuration).vehicleSequenceAdministrations(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TransportsApi
     */
    public vehicleSequenceArrivalUnmatched(requestParameters: TransportsApiVehicleSequenceArrivalUnmatchedRequest, options?: AxiosRequestConfig) {
        return TransportsApiFp(this.configuration).vehicleSequenceArrivalUnmatched(requestParameters.date, requestParameters.category, requestParameters.number, requestParameters.evaNumber, requestParameters.time, requestParameters.includePosition, requestParameters.includeAmenities, requestParameters.includeOccupancy, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TransportsApi
     */
    public vehicleSequenceDeparture(requestParameters: TransportsApiVehicleSequenceDepartureRequest, options?: AxiosRequestConfig) {
        return TransportsApiFp(this.configuration).vehicleSequenceDeparture(requestParameters.journeyID, requestParameters.departureID, requestParameters.includePosition, requestParameters.includeAmenities, requestParameters.includeOccupancy, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TransportsApi
     */
    public vehicleSequenceDepartureUnmatched(requestParameters: TransportsApiVehicleSequenceDepartureUnmatchedRequest, options?: AxiosRequestConfig) {
        return TransportsApiFp(this.configuration).vehicleSequenceDepartureUnmatched(requestParameters.date, requestParameters.category, requestParameters.number, requestParameters.evaNumber, requestParameters.time, requestParameters.includePosition, requestParameters.includeAmenities, requestParameters.includeOccupancy, options).then((request) => request(this.axios, this.basePath));
    }
}
