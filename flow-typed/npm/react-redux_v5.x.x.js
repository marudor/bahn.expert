...
declare module 'react-redux' {
  ...
  // so to say MP >= P.
  declare type Connector<P, OP, MP: P> = <WC: React$ComponentType<P>>(WC) => Class<ConnectedComponent<OP, WC>> & WC;
  ...
  declare type MergeProps<+P, -OP, -SP, -DP> = (stateProps: SP, dispatchProps: DP, ownProps: OP) => P;
  ...
  declare type SelectorFactory<
    ...
    EFO: Object,
    CP: Object
  > = (dispatch: Dispatch, factoryOptions: SelectorFactoryOptions<Com> & EFO) => MapStateToPropsEx<S, OP, CP>;
