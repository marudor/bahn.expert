...
declare module 'axios' {
  ...
  declare class Axios {
    ...
    post<T, R>(url: string, data?: mixed, config?: AxiosXHRConfigBase<T, R>): AxiosPromise<T, R>;
    put<T, R>(url: string, data?: mixed, config?: AxiosXHRConfigBase<T, R>): AxiosPromise<T, R>;
    patch<T, R>(url: string, data?: mixed, config?: AxiosXHRConfigBase<T, R>): AxiosPromise<T, R>;
    interceptors: {
